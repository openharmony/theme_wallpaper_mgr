...
{
    int nRet = HiSysEventWrite(HiSysEvent::Domain::THEME, SERVICE_FAULT, HiSysEvent::EventType::FAULT, FAULT_TYPE,
...
{
    int nRet = HiSysEventWrite(HiSysEvent::Domain::THEME, RUNTIME_FAULT, HiSysEvent::EventType::FAULT, FAULT_TYPE,
