...
void WallpaperColorChangeListenerProxy::OnColorsChange(const std::vector<uint64_t> &color, int32_t wallpaperType)
{
    ...
    int32_t error = Remote()->SendRequest(ONCOLORSCHANGE, data, reply, option);
    if (error != 0) {
