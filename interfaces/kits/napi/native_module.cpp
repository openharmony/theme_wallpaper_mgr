...
static napi_value Init(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_FUNCTION("getFileSync", NAPI_GetFileSync),
        ...
        DECLARE_NAPI_FUNCTION("isChangeAllowed", NAPI_IsChangeAllowed),
        DECLARE_NAPI_FUNCTION("isOperationAllowed", NAPI_IsOperationAllowed),
        DECLARE_NAPI_FUNCTION("isUserChangeAllowed", NAPI_IsUserChangeAllowed),
